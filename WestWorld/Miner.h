...
//increased this to 6 so he can't go home too soon because of winning
//against the bank robbers (the bank gives him 2 gold for that)
const int ComfortLevel       = 6;
