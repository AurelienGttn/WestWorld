...
//------------------------------------------------------------------------
//
//  this is implemented as a state blip. The miner fights in the bank
//  against the bank robbers and then returns to his previous state
//	regardless of the outcome of the fight
//------------------------------------------------------------------------
class DefendGold : public State<Miner>
{
private:
	...
	//copy ctor and assignment should be private
	DefendGold(const DefendGold&);
	DefendGold& operator=(const DefendGold&);
